...
public class ManageRecords extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtitemcode = (EditText) findViewById(R.id.btnQuery);
        txtDefault = (TextView) findViewById(R.id.btnQuery);
        listView = (ListView) findViewById(R.id.btnQuery);
        textView = (TextView) findViewById(R.id.btnQuery);
        txtDefault_gender = (TextView) findViewById(R.id.btnQuery);
        txtDefault_civilStatus = (TextView) findViewById(R.id.btnQuery);
        txtDefault_ID = (TextView) findViewById(R.id.btnQuery);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                alert_confirm.setPositiveButton(R.string.msg2, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        txtDefault_ID.set.Text(cItemSelected_ID);
                        aydi = txtDefault_ID.getText().toString().trim();
                        new delete().execute();
    ...
    private class Gender extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String Gender) {
            ...
            if (Gender != null) {
                ...
                list_fnames = new ArrayList<String>(Arrays.asList(Genders));
                adapter_fnames = new ArrayAdapter<String>(ManageRecords.this,
                        android.R.layout.simple_list_item_1, list_fnames);
    ...
    private class Civil extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String CS) {
            ...
            if (CS != null) {
                ...
                list_fnames = new ArrayList<String>(Arrays.asList(Civs));
                adapter_fnames = new ArrayAdapter<String>(ManageRecords.this,
                        android.R.layout.simple_list_item_1, list_fnames);
    ...
    private class id extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String aydi) {
            ...
            if (aydi != null) {
                ...
                list_fnames = new ArrayList<String>(Arrays.asList(ayds));
                adapter_fnames = new ArrayAdapter<String>(ManageRecords.this,
                        android.R.layout.simple_list_item_1, list_fnames);
